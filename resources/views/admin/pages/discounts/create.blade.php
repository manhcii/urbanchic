...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        <form role="form" action="{{ route(Request::segment(2) . '.store') }}" method="POST" id="form_discount">
            <div class="row">
                <div class="col-lg-8">
                                        ...
                                        <div class="d-flex-wap">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="@lang('Name Coupon')" value="{{ old('name') }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control coupon_code" name="coupon_code"
                                                        placeholder="@lang('Customers will enter this coupon code when they checkout.')" value="{{ old('coupon_code') }}"
                                                        required>
                                                      
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="checkbox" id="unlimited" name="is_unlimited" checked value="unlimited">
                                                <label for="unlimited">@lang('Unlimited coupon') </label>
                                            </div>

                                            <div class="col-md-12 enter_number is_unlimited_block">
                                                <div class="form-group">
                                                    <label>@lang('Enter quantity') </label>
                                                    <input type="number" required disabled class="form-control w-50 coupon_quantity"  name="coupon_quantity">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="discount" class="form-control"  value="{{ old('discount')?? 1}}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 "> 
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 d-none amount-minimum-order apply_list">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" required name="amount_minimum_order" class="form-control" disabled>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="datetime-local" required class="form-control" name="time_start" value="{{$dts->format('Y-m-d\TH:i:s')}}">
                                    </div>
                                </div>   
                            </div>
                        </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">   
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input required disabled type="datetime-local" class="form-control end_time" name="time_end" value="{{$dte->format('Y-m-d\TH:i:s')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">  
                            <input type="checkbox" value="1" name="never_expired" checked  id="never_expired">    
