    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('call_request.select.all') }}"  data-url="{{ route('call_request.select.all') }}" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="GET" method="GET">
                    <button type="button" class="form-control" data-url="{{ route('call_request.select.all') }}" name="submit">Đồng ý</button>
                </form>
            </div>
        </div>
    </div>
