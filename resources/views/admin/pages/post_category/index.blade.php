                                            ...
                                            <tr class="valign-middle">
                                                ...
                                                <td>
                                                    <input data-token="{{ csrf_token() }}"
                                                        data-url="{{ route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $row->id]) }} "
                                                ...
                                                <td class="wrap-load-active" data-token="{{ csrf_token() }}"
                                                    data-url="{{ route('admin.loadStatusPostCategory', ['id' => $row->id]) }}">
                                            ...
                                            @if ($sub->parent_id == $row->id)
                                                <form action="{{ route(Request::segment(2) . '.destroy', $sub->id) }}"
                                                    ...
                                                    <tr class="valign-middle bg-gray-light">
                                                        ...
                                                        <td>
                                                            - - - -<input data-token="{{ csrf_token() }}"
                                                                data-url="{{ route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $sub->id]) }} "
                                                        ...
                                                        <td class="wrap-load-active" data-token="{{ csrf_token() }}"
                                                            data-url="{{ route('admin.loadStatusPostCategory', ['id' => $sub->id]) }}">
                                                            @include(
                                                    ...
                                                    @if ($sub_child->parent_id == $sub->id)
                                                        <form
                                                            ...
                                                            <tr class="valign-middle bg-gray-light">
                                                                ...
                                                                <td>
                                                                    - - - - -<input data-token="{{ csrf_token() }}"
                                                                        data-url="{{ route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $sub_child->id]) }} "
                                                                        class="lb-order text-center" type="number"
                                                                        min="0"
                                                                ...
                                                                <td class="wrap-load-active"
                                                                    ...
                                                                    data-url="{{ route('admin.loadStatusPostCategory', ['id' => $sub_child->id]) }}">
                                                                    @include(
                                                                        'admin.components.load-change-status',
                                                                        [
                                                                            'data' => $sub_child,
