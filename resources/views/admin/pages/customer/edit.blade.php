                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="@lang('Name')" value="{{ $detail->name }}"
                                                        required>
                                                </div>
                                            </div>
                                                ...
                                                <label>@lang('Country')</label>
                                                    <select name="country_id" class="country-select form-control select2">
                                                         @foreach($country as $key => $val)
                                                            <option value="{{ $val->id }}"
                                                                {{ isset($detail->country_id) && $detail->country_id == $val->id ? 'selected' : '' }}>
                                                                {{ $val->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                           ...
                                           <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="street_address"
                                                        placeholder="@lang('Address')" value="{{ $detail->street_address }}"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                  ...
                                                  <input type="password" class="form-control" name="password_new" placeholder="@lang('Password must be at least 6 characters')"
