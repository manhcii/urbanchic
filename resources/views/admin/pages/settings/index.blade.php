                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                @lang('Header Title Topbar')
                                            </label>
                                            <input type="text" class="form-control" name="title_topbar"
                                                placeholder="@lang('Address')"
                                                value="{{ old('title_topbar') ?? ($lang == $languageDefault->lang_locale ? $setting->title_topbar : $setting->{$lang . '-title_topbar'}) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="currency_unit"
                                                placeholder="@lang('Currency unit')"
                                                value="{{ old('currency_unit') ?? ($lang == $languageDefault->lang_locale ? $setting->currency_unit : ($setting->{$lang . '-currency_unit'}??'')) }}">
