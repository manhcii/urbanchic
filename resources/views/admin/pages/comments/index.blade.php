                      ...
                      @foreach ($rows as $row)
                        <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}" method="POST"
                          ...
                          <tr class="valign-middle">
                            ...
                            <td class="wrap-load-active" data-token="{{ csrf_token() }}" data-url="{{ route('admin.loadStatusComment',['id'=>$row->id]) }}">
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form action="{{ route('comment.select.all') }}"  data-url="{{ route('comment.select.all') }}" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="GET" method="GET">
                      <button type="button" class="form-control" data-url="{{ route('comment.select.all') }}" name="submit">Đồng ý</button>
                  </form>
              </div>
          </div>
      </div>
