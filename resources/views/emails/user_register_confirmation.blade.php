...
@section('content')
  <div class="container" style="max-width:80%;margin:auto;background:#FBFBFB;">
    ...
    <div style="padding:20px">
      ...
      <p>
        {{ __('You have successfully registered an account at EduCV, we will assist you in accomplishing your goals with many perks and help you connect globally.') }}
      </p>
      <p>
        <strong style="font-style: italic;">
      ...
      <p>
        <strong>
          {{ __('Contact us for more support:') }}
        </strong>
        <br>
        - Hotline: 
        - Email: 
