      ...
      <div class="modal-content login-modal">
        ...
        <div class="login-container">
          ...
          <div class="login-right">
            ...
            <img class="logo" src="{{ asset('themes/frontend/assets/image/logo-color.svg') }}" alt="Savory Spree" title="Savory Spree" />
            <h2>Welcome Back</h2>
            ...
            <div class="login-other">
              <a href="javascript:void(0)" onclick="alert('@lang('Function is being completed')')" class="login-other-btn" title="Sign in with Google">
              ...
              <a href="javascript:void(0)" onclick="alert('@lang('Function is being completed')')" class="login-other-btn" title="Sign in with Icloud">
              ...
              <a href="javascript:void(0)" onclick="alert('@lang('Function is being completed')')" class="login-other-btn" title="Sign in with Facebook">
            ...
            <form class="login-form" id="login_form" method="post" action="{{ route('frontend.login.post') }}">
                @csrf
                @php
              ...
              <div class="login-form-bottom">
                ...
                <a href="{{ route('frontend.password.forgot.get') }}" class="login-form-forgot d-block" title="Forgot your password?">Forgot your password?</a>
              </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="login-image-item">
                    <img src="{{ asset('themes/frontend/assets/image/popup-login-banner.png') }}" alt="Loggin"
                      title="Loggin" />
                    <p>
                ...
                <div class="swiper-slide">
                  <div class="login-image-item">
                    <img src="{{ asset('themes/frontend/assets/image/popup-register.png') }}" alt="Loggin"
                      title="Loggin" />
                    <p>
                      Start for free and improve your speaker carrer just in one
                      click.
        ...
        <div class="icon-leaf">
          <img src="{{ asset('themes/frontend/assets/image/popup-login-leaf.png') }}" alt="Savory Spree" title="Savory Spree">
        </div>
  
        <div class="icon-leaf">
          <img src="{{ asset('themes/frontend/assets/image/popup-login-leaf-2.png') }}" alt="Savory Spree" title="Savory Spree">
        </div>

        <div class="icon-leaf">
          <img src="{{ asset('themes/frontend/assets/image/popup-login-leaf-3.png') }}" alt="Savory Spree" title="Savory Spree">
        </div>

        <div class="icon-leaf">
          <img src="{{ asset('themes/frontend/assets/image/popup-login-leaf-4.png') }}" alt="Savory Spree" title="Savory Spree">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="modal-content login-modal">
        <div class="login-container">
          <div class="login-right">
            ...
            <form class="login-form signin-form" id="signup_form"method="post" action="{{ route('frontend.register') }}">
                @csrf
                @php
                    $referer = request()->headers->get('referer');
                    $current = url()->full();
