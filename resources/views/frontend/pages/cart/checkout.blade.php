            ...
            <section id="fhm-shopping-cart-breadcrumb" class="breadcrumb">
                <div class="container">
                    <div class="breadcrumb-list">
                        ...
                        <span class="breadcrumb-link-current">@lang('Checkout')</span>
                    </div>
                </div>
            </section>
                    ...
                    <div class="checkout-wrapper">
                        <div class="checkout-left">
                            <div class="checkout-express">
                                <h4>@lang('Express Checkout')</h4>
                                <div class="checkout-express-select d-flex">
                                    <a href="avascript:void(0)" onclick="alert('@lang('Function is being completed')')" title="ShopPay">
                                    ...
                                    <a href="avascript:void(0)" onclick="alert('@lang('Function is being completed')')" title="PayPal"><svg
                                    ...
                                    <a href="avascript:void(0)" onclick="alert('@lang('Function is being completed')')"
                            ...
                            <h6 class="checkout-or">@lang('Or')</h6>
                            <form class="main-form" action="{{ route('frontend.order.store.product') }}"
                                method="POST">
                                @csrf
                                @php
                                    $total_coupon = 0;
                                ...
                                <div class="main-form-group">
                                    ...
                                    <div class="main-form-check d-flex align-items-center">
                                        ...
                                        <label for="email-with-me" style="font-weight: 300">@lang('Email me with news and offers')</label>
                                    </div>
                                </div>
                                <div class="main-form-group">
                                    ...
                                    <div class="main-form-select">
                                        ...
                                        <select class="main-form-control country-select" name="json_params[country]">
                                            ...
                                            @foreach ($country as $val)
                                                <option {{ old('json_params.country') == $val->id ? 'selected' : '' }}
                                    ...
                                    <div class="main-form-btn d-flex justify-content-between align-items-center">
                                        <a href="{{ route('frontend.order.cart') }}" title="Return to Cart"><svg
                                            ...
                                            @lang('Return to Cart')</a>
                                        <button type="submit" class="button-solid">
                                            @lang('Continue Shipping')
                                        </button>
                                    </div>
                                </div>
                            </form>
                                                ...
                                                <div class="payment-product-info-wrapper">
                                                    <div class="payment-product-info">
                                                        <a href="{{ route('frontend.page', ['taxonomy' => $details['alias'] ?? '']) }}"
                                                            title="Antique Wooden Foldable">{{ $details['title'] }}</a>
                                                    </div>
                                                    <span class="payment-product-quantity">x1</span>
                                                    <div class="payment-product-price">
                                                        {{ $lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'} }}{{ number_format($details['price'], 2) }}
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="payment-bill">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <th>@lang('Subtotal')</th>
                                                <td>{{ $lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'} }}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Session::get('coupon'))
                                                        ...
                                                        @endphp
                                                        <span>-${{ number_format($total_coupon, 2) }}</span>
                                                        <h5 class="discounts">
                                                            {{ session('coupon')['name'] }}
                                                        </h5>
                                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <input type="radio" name="ship_fee" data-index="0"
                                                        value="0"checked
                                                        class="shipping_method"><label>@lang('Free Ship') </label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                 <span>
                                                 {{ $lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'} }}

                                                 </span>
                                                    <span class="subtotle" data = "{{$total}}">{{ number_format($total, 2) }}</span></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
