                ...
                <div class="blog-detail-main">
                    ...
                    <div class="blog-detail-action-info">
                        <div class="blog-detail-post">
                            <img src="{{ asset('themes/frontend/assets/image/icons/blog-detail-post.svg') }}" alt="Post" title="Post">

                            <span>{{ $time }}</span>
                        </div>

                        <div class="blog-detail-comment-quantity">
                            <img src="{{ asset('themes/frontend/assets/image/icons/blog-detail-comment.svg') }}" alt="Comment" title="Comment">      
                                                       
                            <span>{{ $comment_number>0?$comment_number:"No Comment" }}</span>
                        </div>
                    </div>
                    ...
                    <div class="blog-detail-comment">
                        ...
                        <form action="{{ route('frontend.comment') }}"method="post" id="blogComment">
                            @csrf
                        ...
                        <div class="list-comment">
                            @if(isset($comment) && count( (array)$comment)>0)
                            @foreach ($comment as $val)
                                <div class="comment-item">
                                    <img src="{{ asset('themes/frontend/assets/image/blogs/blog-detail-human.png') }}" alt="Annette White" title="Annette White">
                                    <div class="comment-item-detail">
                                        <div class="comment-item-info">
                                            <span class="comment-name">{{ $val->name??"" }}</span>
                                            <span>•</span>
                                            <span class="comment-post">{{ date('d M, Y', strtotime($val->created_at)) }}</span>
                                        </div>
