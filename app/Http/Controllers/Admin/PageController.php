...
class PageController extends Controller
{
    ...
    public function edit(Page $page)
    {
        ...
        $widgets_config = WidgetConfig::all();
        ...
        $this->responseData['widgets_config'] = $widgets_config;
    ...
    public function update(Request $request, Page $page)
    {
        ...
        $arr_widget = [];
        if (!empty($params['json_params']['widget']) && count($params['json_params']['widget']) > 0) {
            foreach ($params['json_params']['widget'] as $val) {
                $arr_widget[] = (int)$val;
            }
        }
        $params['json_params']['widget'] = $arr_widget;
        $params['json_params']['title'][$lang] = $request['title'];
        $params['json_params']['description'][$lang] = $request['description'];
        $params['json_params']['content'][$lang] = $request['content'];
