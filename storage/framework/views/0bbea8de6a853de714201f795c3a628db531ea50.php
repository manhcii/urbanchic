                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <form class="form-component" role="form"
                                    ...
                                    <?php if(isset($component_configs)): ?>
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="json_params[style]" id="component_style" class="form-control select2"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="image" class="form-control" type="text" name="image"
                                                    value="<?php echo e($detail->image); ?>" placeholder="<?php echo app('translator')->get('Image source'); ?>">
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/components/edit/footer.blade.php ENDPATH**/ ?>