                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        <?php echo e($row->coupon_code); ?>

                      </td>
                      <td>
                        <?php echo e($row->discount); ?><?php echo e($row->coupon_type); ?>

                      </td>
                      <td>
                        <div class="box-header sw_featured d-flex-al-center">
                            <label class="switch ">
                                <input data-id="<?php echo e($row->id); ?>" data-action="<?php echo e(route('status_coupon')); ?>" class="sw_featured_input" name="status" value="1" type="checkbox"
                                    <?php echo e(isset($row->status) && $row->status == 'active' ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/discounts/index.blade.php ENDPATH**/ ?>