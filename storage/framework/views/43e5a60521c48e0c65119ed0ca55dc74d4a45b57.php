            ...
            <section id="fhm-shopping-cart-breadcrumb" class="breadcrumb">
                <div class="container">
                    <div class="breadcrumb-list">
                        ...
                        <span class="breadcrumb-link-current"><?php echo app('translator')->get('Checkout'); ?></span>
                    </div>
                </div>
            </section>
                    ...
                    <div class="checkout-wrapper">
                        <div class="checkout-left">
                            <div class="checkout-express">
                                <h4><?php echo app('translator')->get('Express Checkout'); ?></h4>
                                <div class="checkout-express-select d-flex">
                                    <a href="avascript:void(0)" onclick="alert('<?php echo app('translator')->get('Function is being completed'); ?>')" title="ShopPay">
                                        <svg width="125" height="45" viewBox="0 0 125 45" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect width="125" height="44.7947" rx="5" fill="#5A31F4" />
                                            <mask id="mask0_286_375" style="mask-type: luminance"
                                                maskUnits="userSpaceOnUse" x="15" y="11" width="95" height="23">
                                    ...
                                    <a href="avascript:void(0)" onclick="alert('<?php echo app('translator')->get('Function is being completed'); ?>')" title="PayPal"><svg
                                            width="125" height="46" viewBox="0 0 125 46" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect width="125" height="45.0736" rx="5" fill="#003087" />
                                            <path
                                    ...
                                    <a href="avascript:void(0)" onclick="alert('<?php echo app('translator')->get('Function is being completed'); ?>')"
                                        title="Apple Pay"><svg width="125" height="46" viewBox="0 0 125 46"
                                    ...
                                    <a href="avascript:void(0)" onclick="alert('<?php echo app('translator')->get('Function is being completed'); ?>')"
                                        title="Google Pay"><svg width="125" height="46" viewBox="0 0 125 46"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h6 class="checkout-or"><?php echo app('translator')->get('Or'); ?></h6>
                            <form class="main-form" action="<?php echo e(route('frontend.order.store.product')); ?>"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <?php
                                    $total_coupon = 0;
                                ...
                                <?php if(Session::get('coupon')): ?>
                                    ...
                                    <input type="hidden" name="discount"
                                        value="<?php echo e(number_format($total_coupon, 2)); ?>"class="discount-price-value">
                                    <?php if(isset(session('coupon')['id']) && session('coupon')['id'] != ''): ?>
                                        <input type="hidden" name="json_params[id_discount]"
                                            value="<?php echo e(session('coupon')['id']); ?>"class="id-discount-value">
                                    <?php endif; ?>
                                <?php endif; ?>
                                <input type="hidden" name="shipping" class="val_ship" value="0">
                                <input type="hidden" name="total" class="val_total" value="0">
                                <div class="main-form-group">
                                    <div class="main-form-heading d-flex justify-content-between align-content-center">
                                        <h4><?php echo app('translator')->get('Contact'); ?></h4>
                                    </div>
                                    <div class="position-relative">
                                        <div class="main-form-wrapper">
                                            <input type="email" class="form-control main-form-control"
                                                id="email-checkout" name="email" required placeholder="Email..." />
                                    ...
                                    <div class="main-form-check d-flex align-items-center">
                                        <div class="checkbox">
                                            <input class="" name="json_params[emailWithNews]" type="checkbox"
                                                value="1" id="email-with-me" checked />
                                        ...
                                        <label for="email-with-me" style="font-weight: 300"><?php echo app('translator')->get('Email me with news and offers'); ?></label>
                                    </div>
                                </div>
                                <div class="main-form-group">
                                    <div class="main-form-heading">
                                        <h4><?php echo app('translator')->get('Shipping Address'); ?></h4>
                                    </div>
                                    <div class="main-form-select">
                                        <label><?php echo app('translator')->get('Country'); ?></label>
                                        <select class="main-form-control country-select" name="json_params[country]">
                                            <option selected disabled value="">
                                                <?php echo app('translator')->get('United State'); ?>
                                            </option>
                                            <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('json_params.country') == $val->id ? 'selected' : ''); ?>

                                                    <?php echo e(isset($user_auth->country_id) && $user_auth->country_id == $val->id ? 'selected' : ''); ?>
                                    ...
                                    <div class="row">
                                        <div class="col main-form-left">
                                            <div class="main-form-wrapper">
                                                <input type="text" name="name" required
                                                    class="form-control main-form-control" id="first-name"
                                        ...
                                        <div class="col main-form-right">
                                            <div class="main-form-wrapper">
                                                <input type="text" name="json_params[last_name]" required
                                                    class="form-control main-form-control" id="last-name"
                                    ...
                                    <div class="main-form-wrapper">
                                        <input type="text" name="phone" required
                                            class="form-control main-form-control" id="company-checkout"
                                            placeholder="Phone*" />
                                        <div class="clear-input position-absolute d-none">
                                    ...
                                    <div class="main-form-wrapper">
                                        <input type="text" name="json_params[address]"
                                            class="form-control main-form-control" id="address-checkout"
                                            placeholder="Address" />
                                        <div class="clear-input position-absolute d-none">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="row">
                                        <div class="col main-form-left">
                                            <div class="main-form-wrapper">
                                                <div class="main-form-wrapper">
                                                    <input type="text" name="json_params['city']"
                                                        class="form-control main-form-control" id="city-checkout"
                                        ...
                                        <div class="col main-form-right">
                                            <div class="main-form-wrapper">
                                                <input type="text" name="json_params[code]"
                                                    class="form-control main-form-control" id="code-checkout"
                                    ...
                                    <div class="main-form-btn d-flex justify-content-between align-items-center">
                                        <a href="<?php echo e(route('frontend.order.cart')); ?>" title="Return to Cart"><svg
                                            ...
                                            <?php echo app('translator')->get('Return to Cart'); ?></a>
                                        <button type="submit" class="button-solid">
                                            <?php echo app('translator')->get('Continue Shipping'); ?>
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="checkout-right">
                            <?php if(session('cart')): ?>
                                        ...
                                        <?php $__currentLoopData = $items_cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="payment-product">
                                                <div class="payment-product-img">
                                                    <span class="count"><?php echo e($details['quantity']); ?></span>
                                                ...
                                                <div class="payment-product-info-wrapper">
                                                    <div class="payment-product-info">
                                                        <a href="<?php echo e(route('frontend.page', ['taxonomy' => $details['alias'] ?? ''])); ?>"
                                                            title="Antique Wooden Foldable"><?php echo e($details['title']); ?></a>
                                                    </div>
                                                    <span class="payment-product-quantity">x1</span>
                                                    <div class="payment-product-price">
                                                        <?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?><?php echo e(number_format($details['price'], 2)); ?>
                                ...
                                <div class="payment-discount">
                                    <form action="<?php echo e(route('frontend.order.coupon.add')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input name="coupon_code" placeholder="Gift card or discount code" />
                                        <button class="button-solid payment-discount-apply">
                                            <?php echo app('translator')->get('Apply'); ?>
                                        </button>
                                        <?php $subtotal_coupon_from = 0 ?>
                                        <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details_c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $__currentLoopData = $details_c; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details_c_chil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $subtotal_coupon_from += $details_c_chil['price'] * $details_c_chil['quantity'];
                                                ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <input type="hidden" name="amount_sub"value="<?php echo e($subtotal_coupon_from); ?>">
                                    </form>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?>

                                                    <?php echo e(number_format($total, 2)); ?></td>
                                            </tr>
                                            <tr>
                                                <th><?php echo app('translator')->get('Discounts'); ?></th>
                                                <td>
                                                    <?php if(Session::get('coupon')): ?>
                                                        <?php
                                                            if (session('coupon')['coupon_type'] == 'pecent') {
                                                        ...
                                                        ?>
                                                        <span>-$<?php echo e(number_format($total_coupon, 2)); ?></span>
                                                        <h5 class="discounts">
                                                            <?php echo e(session('coupon')['name']); ?>
                                                    ...
                                                    <?php if(Session::get('coupon')): ?>
                                                        <a
                                                            onclick="return confirm('Delete this coupon??')"href="<?php echo e(route('frontend.order.coupon.del')); ?>">
                                                            <button type="button"
                                                                class="btn btn-dark delete_coupon"><i
                                            ...
                                            <tr>
                                                <th><?php echo app('translator')->get('Shipping Fee'); ?></th>
                                                <td
                                                    class="shipping shipping-methods d-flex align-items-center justify-content-end flex-wrap">
                                                    <input type="radio" name="ship_fee" data-index="0"
                                                        value="0"checked
                                                        class="shipping_method"><label><?php echo app('translator')->get('Free Ship'); ?> </label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                 <span>
                                                 <?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?>


                                                 </span>
                                                    <span class="subtotle" data = "<?php echo e($total); ?>"><?php echo e(number_format($total, 2)); ?></span></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/pages/cart/checkout.blade.php ENDPATH**/ ?>