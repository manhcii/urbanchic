            ...
            <section id="fhm-shopping-cart-breadcrumb" class="breadcrumb">
                <div class="container">
                    <div class="breadcrumb-list">
                        ...
                        <a href="<?php echo e(route('home.default')); ?>" title="<?php echo app('translator')->get('Home'); ?>"
                            class="breadcrumb-link"><?php echo app('translator')->get('Home'); ?></a>
                        ...
                        <span class="breadcrumb-link-current"><?php echo app('translator')->get('Shopping Cart'); ?></span>
                    </div>
                </div>
            </section>
            ...
            <section id="fhm-shopping-cart" class="shopping-cart">
                <div class="container">
                    <div class="shopping-cart-heading position-relative">
                        <h1><?php echo app('translator')->get('Shopping Cart'); ?><span>(<?php echo e(count((array) session('cart') ?? 0)); ?>)</span></h1>
                    </div>
                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $items_cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $items_cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <tr class="cart-product" data-id='<?php echo e($details['id']); ?>'
                                                        data-arr="<?php echo e($key); ?>">

                                                        <td class="cart-img">
                                                            <img src="<?php echo e($details['image']); ?>"
                                                                title="<?php echo e($details['title']); ?>"
                                                                alt="<?php echo e($details['title']); ?>" />
                                                        </td>
                                                        <td class="cart-info">
                                                            <div class="cart-info-content">
                                                                <a href="<?php echo e(route('frontend.page', ['taxonomy' => $details['alias'] ?? ''])); ?>"
                                                                    title="<?php echo e($details['title']); ?>">
                                                                    <?php echo e($details['title']); ?> </a>
                                                                <span><?php echo e($details['bfief'] ?? ''); ?></span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="cart-price">
                                                            <h4><?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?>
                                ...
                                <div class="shopping-cart-label">
                                    <div class="order">
                                        ...
                                        <div class="order-container">
                                            <h5><?php echo app('translator')->get('Order Summary'); ?></h5>
                                            <table class="table order-table">
                                                <tbody>
                                                    <tr>
                                                        <th><?php echo app('translator')->get('Subtotal'); ?></th>
                                                        <td>
                                                            <?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?><?php echo e(number_format($total, 2)); ?>

                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <th><?php echo app('translator')->get('Total'); ?><span> ( <?php echo e($item_cart); ?>

                                                            <?php echo app('translator')->get('items'); ?>)</span></th>
                                            ...
                                            <a href="/checkout" class="button-solid"><?php echo app('translator')->get('Checkout with Us'); ?></a>
                                        </div>
                                    </div>
                                    <div class="protection">
                                        <div class="protection-content">
                                            <h6>
                                                ...
                                                <?php echo app('translator')->get('Buyer Protection'); ?>
                                            </h6>
                                            <p><?php echo app('translator')->get('Get full refund if the item is not as described or if is not delivered'); ?></p>
                                        </div>
                        ...
                        <?php else: ?>
                            <div class="shop-cart-empty">
                                <div class="notices-wrapper">
                                    <p class="cart-empty"><?php echo app('translator')->get('Your cart is currently empty'); ?>.</p>
                                </div>
                                <div class="return-to-shop">
                                    <a class="button" href="/">
                                        <?php echo app('translator')->get('Return to shop'); ?>
                                    </a>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/pages/cart/default.blade.php ENDPATH**/ ?>