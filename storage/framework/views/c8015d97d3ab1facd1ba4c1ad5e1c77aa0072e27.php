                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <?php echo app('translator')->get('Header Title Topbar'); ?>
                                            </label>
                                            <input type="text" class="form-control" name="title_topbar"
                                                placeholder="<?php echo app('translator')->get('Address'); ?>"
                                                value="<?php echo e(old('title_topbar') ?? ($lang == $languageDefault->lang_locale ? $setting->title_topbar : $setting->{$lang . '-title_topbar'})); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fruit\resources\views/admin/pages/settings/index.blade.php ENDPATH**/ ?>