          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="component_code" placeholder="<?php echo app('translator')->get('component_code'); ?>"
                value="<?php echo e(old('component_code')); ?>" required>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fruit\resources\views/admin/pages/component_configs/create.blade.php ENDPATH**/ ?>