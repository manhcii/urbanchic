                                                                ...
                                                                <div class="col-lg-2 col-md-3 col-sm-4 mb-1 gallery-image">
                                                                    <div id="image-holder_<?php echo e($key); ?>"
                                                                        ...
                                                                        <img width="150px" height="150px" class="img-width"
                                                                            src="<?php echo e($value->img ?? ''); ?>">
                                                                    </div>
                                                                    <input type="text"
                                                                        name="json_params[gallery_image][<?php echo e($key); ?>][color]"
                                                                        class="form-control" value="<?php echo e($value->color ?? ''); ?>">
                                                                    <input type="text"
                                                                        name="json_params[gallery_image][<?php echo e($key); ?>][img]"
                                                                        class="hidden input_hidden"
                                                                        id="gallery_image_<?php echo e($key); ?>"
                                                                        value="<?php echo e($value->img ?? ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ul class="list-relation row">
                                            <input type="hidden"
                                                ...
                                                value="<?php echo e($val->code??Str::slug($val->name)); ?>">
        ...
        $(document).ready(function() {
            ...
            $('.add-gallery-image').click(function(event) {
                ...
                elementAppend +=
                    ...
                    '][img]" class="hidden" id="gallery_image_' +
                    keyRandom +
                    '">';
                elementAppend += '<input type="text" name = "json_params[gallery_image][' + keyRandom + '][color]" class = "form-control" value = "" > ';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>