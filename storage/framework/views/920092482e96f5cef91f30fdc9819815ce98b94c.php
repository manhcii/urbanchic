                        ...
                        <?php if($block_childs): ?>
                            <ul class="list">
                                <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="item">
                                        <div class="icon">
                                            <img src="<?php echo e(asset('themes/frontend/assets/images/elements/icons/checked-dark.svg')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pizza\resources\views/frontend/blocks/custom/styles/products_introduce.blade.php ENDPATH**/ ?>