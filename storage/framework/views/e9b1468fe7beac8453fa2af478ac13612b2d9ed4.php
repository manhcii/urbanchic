                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-9 col-xs-12"><?php echo e($detail->json_params->address ?? ''); ?></label>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 text-right text-bold"><?php echo app('translator')->get('Note'); ?>:</label>
                                    <label class="col-sm-9 col-xs-12"><?php echo e($detail->json_params->note ?? ''); ?></label>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 text-right text-bold"><?php echo app('translator')->get('Discount'); ?>:</label>
                                    <label
                                        class="col-sm-9 col-xs-12"><?php echo e($detail->discount ? '$' . $detail->discount : ''); ?></label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 text-right text-bold"><?php echo app('translator')->get('Shipping'); ?>:</label>
                                    <label
                                        class="col-sm-9 col-xs-12"><?php echo e($detail->shipping ? '$' . $detail->shipping : ''); ?></label>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 text-right text-bold"><?php echo app('translator')->get('Payment'); ?>:</label>
                                    <div class="col-sm-9 col-xs-12 ">
                                        <?php $__currentLoopData = App\Consts::PAYMENT_STATUS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label>
                                                <input type="radio" name="payment_status" class="<?php echo e($detail->status == 1 ? 'completed' : ''); ?>" value="<?php echo e($key); ?>"
                                                    <?php echo e($detail->payment_status == $key ? 'checked' : ''); ?> >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12 ">
                                        ...
                                        <p class="text-warning">
                                            Đơn này sẽ được đóng sau khi chuyển sang trạng thái <?php echo app('translator')->get(App\Consts::ORDER_STATUS['1']); ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-9 col-xs-12">$<?php echo e(number_format($detail->total)); ?></label>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <?php $__currentLoopData = App\Consts::PAYMENT_METHOD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label>
                                                    <input type="radio" name="json_params[payment_method]"
                                        ...
                                        <tr class="valign-middle">
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <a target="_blank" href="<?php echo e(route('frontend.page', ['taxonomy' => $row->alias ?? ''])); ?>">
                                                            <img src="<?php echo e($row->image_thumb ?? $row->image); ?>"
                                                    ...
                                                    <div class="col-12 col-md-8 ">
                                                        ...
                                                        <p class="size"><?php echo app('translator')->get('Size'); ?>:
                                                            <?php echo e($row->json_params->size ?? ''); ?>

                                                        </p>
                                                        <p class="color ml-2"><?php echo app('translator')->get('Color'); ?>:
                                                            <span class="box_bg_color" style="background-color: <?php echo e($row->json_params->color ?? ''); ?>">
                                                            </span>
                                                        </p>
                                                    </div>
                                            ...
                                            <td>
                                                <input class="form-control" name="price" type="number"
                                                    value="<?php echo e($row->price); ?>" min="0"
                                                    onchange="this.form.submit()">
                                            </td>
                                            <td>
                                                <input class="form-control" type="number" name="quantity"
                                                    value="<?php echo e($row->quantity); ?>" min="1"
                                                    onchange="this.form.submit();">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-danger remove-order-detail" type="button"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/orders/order_product_show.blade.php ENDPATH**/ ?>