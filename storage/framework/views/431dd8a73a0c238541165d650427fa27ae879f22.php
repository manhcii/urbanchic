...
<section id="fhm-contact-us-breadcrumb" class="breadcrumb">
    <div class="container">
      <div class="breadcrumb-list">
        ...
        <span class="breadcrumb-link"><?php echo e($page->json_params->title->{$locale} ?? $page->title); ?></span>
      </div>
    </div>
  </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\urbanchic\resources\views/frontend/pages/page/default.blade.php ENDPATH**/ ?>