                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-12 col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][<?php echo e($lang); ?>]" id="description" class="form-control" rows="5"><?php echo e(old('json_params[description][' . $lang . ']') ?? ($detail->json_params->description->{$lang} ?? ($detail->description??''))); ?></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/block_contents/edit/block_star.blade.php ENDPATH**/ ?>