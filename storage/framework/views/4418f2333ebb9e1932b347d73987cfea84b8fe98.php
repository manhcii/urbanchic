            ...
            <ul class="nav-list">
                ...
                <?php $__currentLoopData = $menu_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val_menu1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="nav-item header-logo">
                        <a class="nav-link <?php echo e($active); ?>" href="/" title="Savory Spree">
                          <img src="<?php echo e($setting->logo_header??""); ?>" alt="Savory Spree" title="Savory Spree">
                        </a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item ">
                        <a class="nav-link <?php echo e($active); ?>" href="<?php echo e($val_menu1->url_link); ?>"
                            ...
                            <div class="mega-menu-main">
                              <div class="mega-menu-list">
                                ...
                                <div class="mega-menu-col">
                                  <img src="<?php echo e($val_menu2->json_params->image ?? ""); ?>" alt="Smoothies" title="Smoothies">
                                  <a href="<?php echo e($val_menu2->url_link); ?>" title="<?php echo e($val_menu2->json_params->name->$locale ?? $val_menu2->name); ?>"><?php echo e($val_menu2->json_params->name->$locale ?? $val_menu2->name); ?></a>
                                    ...
                                    ?>
                                        <ul class="mega-menu-col-child">
                                            ...
                                            <li class="nav-item">
                                              <a href="<?php echo e($val_menu3->url_link); ?>" title="<?php echo e($val_menu3->json_params->name->$locale ?? $val_menu3->name); ?>"><?php echo e($val_menu3->json_params->name->$locale ?? $val_menu3->name); ?></a>
                                            </li>
...
<?php /**PATH E:\xampp\htdocs\urbanchic\resources\views/frontend/components/header_default/menu/layout/default.blade.php ENDPATH**/ ?>