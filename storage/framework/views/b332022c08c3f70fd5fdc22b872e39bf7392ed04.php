    ...
    <section class="watch-video">
        <div class="container">
            ...
            <div class="video-wrap">
                <picture>
                    <source media="(max-width:991px)" srcset="<?php echo e($image); ?>">
                    <img class="video-image-back" src="<?php echo e($image); ?>" alt="Watch video" title="Watch video" />
                </picture>

                <button class="button-play-video" 
                data-video="<?php echo e($url_link); ?>" 
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\fruit\resources\views/frontend/blocks/about_us/styles/watch_video.blade.php ENDPATH**/ ?>