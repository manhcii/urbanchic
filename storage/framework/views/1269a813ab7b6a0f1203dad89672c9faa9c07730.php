                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="json_params[taxonomy]" class="form-control select2">
                                                <option value=""><?php echo app('translator')->get('Please select'); ?></option>
                                                <?php $__currentLoopData = $taxonomys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($val->taxonomy == 'product'): ?>
                                                        <option value="<?php echo e($val->id); ?>" <?php echo e((isset($detail->json_params->taxonomy) && $detail->json_params->taxonomy == $val->id) ? "selected":""); ?>>
...
<?php echo $__env->make('admin.layouts.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/block_contents/edit/cms_product.blade.php ENDPATH**/ ?>