            ...
            <section id="fhm-wishlist-breadcrumb" class="breadcrumb">
                <div class="container">
                    <div class="breadcrumb-list">
                        ...
                        <span class="breadcrumb-link-current"><?php echo app('translator')->get('Wishlist'); ?></span>
                    </div>
                </div>
            </section>
            <section id="fhm-wishlist-banner">
                <div class="container">
                    <h1 class="title"><?php echo app('translator')->get('Wishlist'); ?></h1>
                    <p class="desc"><?php echo app('translator')->get('Total'); ?> <strong><?php echo e(count($rows) ?? 0); ?></strong> <?php echo app('translator')->get('items in your wishlist.'); ?></p>
                </div>
            </section>
                            ...
                            <table class="table">
                                <tbody>
                                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr class="cart-product item_product wishlist-<?php echo e($items->id); ?>">
                                            <td class="cart-img">
                                                <img src="<?php echo e($image); ?>" title="<?php echo e($title); ?>"
                                            ...
                                            <td class="cart-price">
                                                <h4><?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?>
                                                    ...
                                                    <?php echo e(number_format($price, 2)); ?></h4>
                                                <?php if($price_old != 0): ?>
                                                    <span><?php echo e($lang_default == $locale ? $setting->currency_unit : $setting->{$locale . '-currency_unit'}); ?>
                                            ...
                                            <td class="cart-delete">
                                                <button class="delete_wishlist" data-id="<?php echo e($items->id); ?>">
                                            ...
                                            <td class="cart-add">
                                                <button class="button-solid add-to-cart" data-id="<?php echo e($items->id); ?>">
                                                    <span class="text"><?php echo app('translator')->get('Add to Cart'); ?></span>
                                                    <span class="icon">
                                                        <img src="<?php echo e(asset('themes/frontend/assets/images/icon/cart-2.svg')); ?>"
                                                            alt="Add to cart" />
                                                    </span>
                                                </button>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/pages/user/wishlist.blade.php ENDPATH**/ ?>