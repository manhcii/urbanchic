          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <textarea name="option_value" id="option_value" class="form-control"
                rows="5"><?php echo ($detail->option_value); ?></textarea>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fruit\resources\views/admin/pages/options/edit.blade.php ENDPATH**/ ?>