    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('call_request.select.all')); ?>"  data-url="<?php echo e(route('call_request.select.all')); ?>" data-ajax="submit" data-target="alert" data-href="#modalAjax" data-content="#content" data-method="GET" method="GET">
                    <button type="button" class="form-control" data-url="<?php echo e(route('call_request.select.all')); ?>" name="submit">Đồng ý</button>
                </form>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/contacts/call_request_list.blade.php ENDPATH**/ ?>