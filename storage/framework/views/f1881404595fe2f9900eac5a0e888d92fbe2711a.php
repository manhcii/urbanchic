            ...
            <div class="contact-wrapper">
                <div class="contact-form">
                    ...
                    <div class="contact-form-heading">
                        ...
                        <div class="d-block d-md-flex justify-content-between align-items-center">
                            ...
                            <span>*<?php echo app('translator')->get('Required'); ?></span>
                        </div>
                    </div>
                    <form action="<?php echo e(route('frontend.contact.store')); ?>" method="post" class="main-form form_ajax">
                        ...
                        <div class="main-form">
                            <div class="row">
                                <div class="col main-form-left">
                                    <div class="main-form-wrapper">
                                        <input type="text" required name="name" class="form-control main-form-control" id="first-name"
                                ...
                                <div class="col main-form-right">
                                    <div class="main-form-wrapper">
                                        <input type="text" required name="json_params[last_name]" class="form-control main-form-control" id="last-name"
                            ...
                            <div class="main-form-wrapper">
                                <input type="email" name="email" required class="form-control main-form-control" id="email"
                                    placeholder="Email*" />
                                <div class="clear-input position-absolute d-none">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="main-form-wrapper">
                                <input type="text" name="json_params[address]" class="form-control main-form-control" id="address"
                                    placeholder="Address" />
                                <div class="clear-input position-absolute d-none">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="main-form-wrapper">
                                <input type="text" name="phone" required class="form-control main-form-control" id="first-name-checkout"
                                    placeholder="Phone*" />
                                <div class="clear-input position-absolute d-none">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="contact-info">
                    <li class="contact-info-item">
                        ...
                        <a href="mailto:<?php echo e($locale == $lang_default ? $setting->email : $setting->{$locale . '-email'} ?? $setting->email); ?>"
                            title="<?php echo e($locale == $lang_default ? $setting->email : $setting->{$locale . '-email'} ?? $setting->email); ?>"
                            class="link"><?php echo e($locale == $lang_default ? $setting->email : $setting->{$locale . '-email'} ?? $setting->email); ?></a>
                    </li>
                    <li class="contact-info-item">
                        <h4 class="title"><?php echo app('translator')->get('Phone'); ?></h4>
                        <a href="tel:<?php echo e($locale == $lang_default ? $setting->phone : $setting->{$locale . '-phone'} ?? $setting->phone); ?>"
                            title="<?php echo e($locale == $lang_default ? $setting->phone : $setting->{$locale . '-phone'} ?? $setting->phone); ?>"
                            class="link"><?php echo e($locale == $lang_default ? $setting->phone : $setting->{$locale . '-phone'} ?? $setting->phone); ?></a>
                    </li>
                    <li class="contact-info-item">
                        <address class="title"><?php echo app('translator')->get('Address'); ?></address>
                        <p class="text">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/blocks/contact/styles/form.blade.php ENDPATH**/ ?>