          ...
          <div class="page-contact-main">
            <div class="page-contact-info text-center">
              <div class="contact-info-item">
                <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-contact-address.svg')); ?>" alt="Address" title="Address">
                <p>
              ...
              <div class="contact-info-item">
                <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-contact-email.svg')); ?>" alt="Email" title="Email">
                <a href="mailto:<?php echo e($setting->email??""); ?>" title="<?php echo e($setting->email??""); ?>"><?php echo e($setting->email??""); ?></a>
                <a href="mailto:<?php echo e($setting->email??""); ?>" title="<?php echo e($setting->email??""); ?>"><?php echo e($setting->email??""); ?></a>
              </div>

              <div class="contact-info-item">
                <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-contact-phone.svg')); ?>" alt="Email" title="Email">
                <a href="tel:<?php echo e($setting->phone??""); ?>" title="<?php echo e($setting->phone??""); ?>"><?php echo e($setting->phone??""); ?></a>
                <a href="tel:<?php echo e($setting->hotline??""); ?>" title="<?php echo e($setting->hotline??""); ?>"><?php echo e($setting->hotline??""); ?></a>
              </div>
            </div>
            ...
            <div class="page-contact-form">
              ...
              <form class="form_ajax" action="<?php echo e(route('frontend.contact.store')); ?>" method="post" id="pageContactForm">
                <?php echo csrf_field(); ?>
            ...
            <div class="icon-leaf">
              <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-about-leaf-2.png')); ?>" alt="Contact Us" title="Contact Us">
            </div>

            <div class="icon-leaf">
              <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-about-about-us-leaf-2.png')); ?>" alt="Contact Us" title="Contact Us">
            </div> 
            
            <div class="icon-leaf">
              <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-about-leaf-1.png')); ?>" alt="Contact Us" title="Contact Us">
            </div> 

            <div class="icon-leaf">
              <img src="<?php echo e(asset('themes/frontend/assets/image/icons/page-about-leaf-4.png')); ?>" alt="Contact Us" title="Contact Us">
            </div> 

            <div class="icon-leaf">
              <img src="<?php echo e(asset('themes/frontend/assets/image/icons/about-us-leaf.png')); ?>" alt="Contact Us" title="Contact Us">
            </div> 
          </div>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\fruit\resources\views/frontend/blocks/contact/styles/form.blade.php ENDPATH**/ ?>