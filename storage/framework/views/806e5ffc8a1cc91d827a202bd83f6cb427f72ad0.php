<?php if($block): ?>
    ...
    <section id="fhm-home-products-3" class="products">
        <div class="container">
                ...
                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="products-item">
                        <div class="products-item-image">
                            ...
                            <button type="button" data-id="<?php echo e($items->id); ?>" class="quickview-button">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/blocks/cms_product/styles/default.blade.php ENDPATH**/ ?>