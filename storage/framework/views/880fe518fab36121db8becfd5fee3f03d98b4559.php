          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Avata'); ?></th>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        <img width="100px" src="<?php echo e($row->avatar ?? url('themes/admin/img/no_image.jpg')); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/customer/index.blade.php ENDPATH**/ ?>