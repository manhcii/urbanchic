                                    ...
                                    <div class="box-form-login">
                                        ...
                                        <div class="box-content">
                                            <div class="form-login">
                                                <form method="post" class="login" action="<?php echo e(route('frontend.login.post')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="username">
...
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/pages/user/login.blade.php ENDPATH**/ ?>