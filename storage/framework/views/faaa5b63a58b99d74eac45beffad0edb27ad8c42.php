    ...
    <div class="header-button-wrapper">
        ...
        <?php else: ?>
            <a href="javascript:void(0)" class="user-button" title="User">
                <img src="<?php echo e(asset('themes/frontend/assets/images/icon/user.svg')); ?>" alt="User" />
            </a>
        <?php endif; ?>
        <button type="button" class="wishlist-button">
            <a href="<?php echo e(route('frontend.wishlist')); ?>">
                <img src="<?php echo e(asset('themes/frontend/assets/images/icon/heart.svg')); ?>" alt="Wishlist" />
            </a>
        </button>
        <button type="button" class="cart-button">
            <a href="<?php echo e(route('frontend.order.cart')); ?>">
                <img src="<?php echo e(asset('themes/frontend/assets/images/icon/cart.svg')); ?>" alt="Cart" />
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\xGifts\resources\views/frontend/components/header_home/header/layout/cart_home.blade.php ENDPATH**/ ?>