                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <form role="form" action="<?php echo e(route(Request::segment(2) . '.update', $detail->id)); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Code'); ?>
                                                <small class="text-red">*</small>
                                            </label>
                                            <select name="json_params[code]" class="form-control select2"
                                                ...
                                                <?php $__currentLoopData = App\Consts::CODE_PARAMATER; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php echo e(isset($detail->json_params->code) && $detail->json_params->code == $val?'selected':''); ?>><?php echo e($val); ?> </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xGifts\resources\views/admin/pages/parameter/edit.blade.php ENDPATH**/ ?>