    ...
    <section id="fhm-about-team">
        <div class="container">
            <div class="heading-block-m">
                <span class="bage"> <?php echo e($brief); ?> </span>
                                ...
                                <div class="swiper-slide">
                                    <div class="team-item">
                                        ...
                                        <div class="team-item-content">
                                            <h3 class="name"><?php echo e($title_childs); ?></h3>
                                            <p class="position"><?php echo e($brief_childs); ?></p>
                                        </div>
                                    </div>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pizza\resources\views/frontend/blocks/about_block/styles/team.blade.php ENDPATH**/ ?>